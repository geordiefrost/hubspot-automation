    ...
    const templates = [
      {
        ...
        description: 'Complete setup for B2B SaaS companies with trial tracking, MRR properties, and sales pipeline',
        industry: 'SaaS',
        config: {
          properties: {
            contacts: [
      ...
      },
      {
        ...
        description: 'Optimized for online retail with order tracking, product interests, and customer lifecycle',
        industry: 'E-commerce',
        config: {
          properties: {
            contacts: [
      ...
      },
      {
        ...
        description: 'Designed for consultancies, agencies, and service providers with project tracking',
